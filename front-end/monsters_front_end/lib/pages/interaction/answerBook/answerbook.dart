...
//     Future<Data> answers = answerbookRepository
//         .searchAnswerbook()
//         .then((value) => Data.fromJson(value));
//     Future<AnswerBook> answerBook = answers.then((value) => AnswerBook.fromJson(value.answerBook));
//     return answerBook;
//   }

//   @override
//   Widget build(BuildContext context) {
//     // getAnswer().then((value) => log(value.answerBook.toString()));
//     return Scaffold(
...
//                       pressed = true;
//                       setState(() {
//                         Future<Data> answers = getAnswer();
//                         answers.then((value) => value.toJson());
//                       });
//                     },
//                     //是否第一次按(按鈕文字)
//                     child: pressed == false
